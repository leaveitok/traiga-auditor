...
def get_extractor() -> Callable[[List[Dict[str, Any]], str], List[Dict[str, Any]]]:
    """Return the configured extract_fn (single swap point)."""
    from core import config
    provider = getattr(config, "AGENDA_LLM_PROVIDER", "keyword")
    if provider in ("none", ""):
