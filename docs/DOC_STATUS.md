...
| `EVIDENCE_BUNDLES_DESIGN.md` | 🟡 PARTIAL | Audience-tailored evidence bundles. **Phase 1 shipped**: bundle engine, Council Brief + AG/Auditor Package presets, PDF+DOCX, zip package, tamper-evident content hash, provenance-first, candidate-not-verdict, Reports section with live preview. Phases 2–4 (persistence/Evidence Room, fast-follow audiences, product-docs) **not built**. |
